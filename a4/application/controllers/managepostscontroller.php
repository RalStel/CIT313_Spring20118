...
class ManagePostsController extends Controller {
    ...
    public function save() {
        ...
        if ($_POST['title'] == "") {
            $this->set('message', 'You must enter a title.');
                    $this->set('task', 'save');

        } elseif ($_POST['content'] == "") {
            $this->set('message', 'You must enter content.');
                    $this->set('task', 'save');

        } elseif ($_POST['category'] == "") {
            $this->set('message', 'You must select a category.');
                    $this->set('task', 'save');

        } elseif ($_POST['date'] == "") {
            $this->set('message', 'You must enter a date.');
                    $this->set('task', 'save');
