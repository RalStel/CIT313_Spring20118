...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        //^FIX: inserted the absolute path to fruit_product.class.php because the user has to be able to select fruits 
        ...
        //^FIX: changed $aryProductsArray to $aryProductArray because the variable names need to match
