...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        //^FIX changed $aryProductsArray into $aryProductArray because matching variable names are necessary for proper execution
        ...
        for ($x = 0; $x < count($aryCartArray); $x++) {
            ...
            //^FIX: needed semicolon at the end of this line in order for the code to execute correctly
