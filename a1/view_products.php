        ...
        <div id="wrapper">
            ...
            <div class="form-container">
                ...
                <form action="<?php echo URL_ROOT . '/add_products_to_cart.php' ?>" method="post">
                    ...
                    //^FIX: changed $arryProductArray to $aryProductArray because the variables need the same name to run properly
                        ?>
                        <fieldset>                           <legend>Product Details</legend>
                            ...
                            <div>
                                ...
                                //^FIX: this semicolon had to be moved above the ending php tag in order for the quantity to show up
                                ?>
                    ...
                    //^FIX: needed another bracket to match up with the one at the start of the for loop
                    ?>
