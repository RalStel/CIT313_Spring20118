...
//^FIX: added all of the classes to index because they needed to be included in order for the code to run properly
?>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="form-container">
                ...
                <?php //^FIX: changed 'URL_ROOT' to URL_ROOT for the code to execute properly ?>
                    ...
                    //^FIX: the parenthesi had to be changed into a bracket to match the bracket at the start of the for loop
                    ?>
